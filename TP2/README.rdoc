...
- Descargar del repo la carpeta de openlayers
- Copiar todos los archivos y pegarlos (reemplazando) en el path de instalación del plugin. (".......\.qgis2\python\plugins\openlayers_plugin")
...
<em>Copyright (c) 2010-2016 Pirmin Kalberer & Mathias Walker, Sourcepole AG</em>
